...
- Worked on "Membership Branch" consisting of Memberships, MembershipDAO, and Membership Service
- Created Member menu with options for viewing available classes, viewing current membership costs, and purchasing new memberships.
- Created neccesary functions for the member menu to work properly using menu actions as it needed to pull from other branches
- Worked with the team on error shooting and testing the various menu functions.
- Created one of the class diagrams for use in documentation.

### Challenges:

- Mostly personal for me as I had family challenges going on
- Trying to understand how the different parts worked together across the different branches
- We had some difficulties with different java versions for compliers and with version control across the team with git
- I used VSC while both Jen and Sarah used Intellij made it hard for me to follow at times as what they were seeing wasn't necesarily what I was seeing.
- I found the logic a bit hard to follow at times, but trusted Sarah and Jennifer completely in that regard.
